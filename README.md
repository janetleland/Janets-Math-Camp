...
After this folder is pushed to GitHub, open the repository settings and enable GitHub Pages from the main branch. The root `index.html` file will become the class welcome page.
